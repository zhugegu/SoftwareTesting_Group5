...
This script tests marshal stability and correctness for float/complex types,
NaN payload variability, and scalar/binary values.
It covers requirements: R1.1, R1.2, R3.1, R3.2, and extension cases.
