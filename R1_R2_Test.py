"""Member A marshal stability tests.

This script tests marshal stability and correctness for basic types,
integers, strings, and variable-length encoding.
It covers requirements: R1.1, R1.2, R2.1, R2.2, R2.3.
"""
...
class TestA1(unittest.TestCase, HelperMixin):
    @test_determinism()
    def test_none(self):
...
class TestA2(unittest.TestCase, HelperMixin):
    @test_determinism()
...
class TestA3(unittest.TestCase, HelperMixin):
    @test_determinism()
...
class TestA4(unittest.TestCase, HelperMixin):
    @test_determinism()
    ...
    @test_determinism()
    def test_intern_same_value(self):
